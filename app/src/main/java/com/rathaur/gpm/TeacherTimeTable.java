...
public class TeacherTimeTable extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RelativeLayout back=findViewById(R.id.teacher_timetable_back_pressed);
        ...
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(TeacherTimeTable.this, "Check Internet Connection", Toast.LENGTH_SHORT).show();
            }
        });
    }
